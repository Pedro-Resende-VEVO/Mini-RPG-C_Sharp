class Personagem
    {
        ...
        public void DistribuirAtributos()
        {
            ...
            while (pontos > 0)
            {
                ...
                Console.WriteLine("Distribua seus pontos entre Ataque e Defesa.");
                ...
                try
                {
                    ...
                    Console.Write("E quantos pontos você deseja adicionar à Defesa? ");
                    int defesa = int.Parse(Console.ReadLine());

                    if (ataque + defesa <= pontos)
                    {
                        this.ataque += ataque;
                        this.defesa += defesa;
            ...
            Console.WriteLine($"\nAtributos definidos! Ataque: {this.ataque}, Defesa: {this.defesa}");
        }
